...
const styles = StyleSheet.create({
  ...
  emptyContainer: {
    ...
    ...Platform.select({
      ios: {
        transform: [{ scaleY: -1 }], // iOS needs this to counteract FlatList inverted prop
      },
      android: {
        // Android handles inverted FlatList ListEmptyComponent differently - no transform needed
      },
    }),
  },
  emptyEmoji: {
