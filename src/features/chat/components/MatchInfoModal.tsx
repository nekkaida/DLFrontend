        ...
        >
          ...
          <View style={styles.section}>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoText}>
                {matchData.duration} hour{matchData.duration > 1 ? "s" : ""}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            >
              <Ionicons
                name={
                  matchData.courtBooked ? "checkmark-circle" : "close-circle"
                }
                size={18}
