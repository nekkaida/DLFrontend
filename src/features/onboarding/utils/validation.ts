 ...
 */
export const validateSportSelection = (
  sports: SportType[],
): ValidationResult => {
 ...
 */
export const isValidationPassing = (validations: {
  [key: string]: ValidationResult;
}): boolean => {
 ...
 */
export const getFirstValidationError = (validations: {
  [key: string]: ValidationResult;
}): string | null => {
  const firstError = Object.values(validations).find(
