...
export default function ResetPasswordNewScreen() {
  ...
  const {
    getVerifiedOtp,
    clearAll: clearPasswordResetStore,
    isOtpValid,
  ...
  useEffect(() => {
    ...
    const checkOtp = setTimeout(() => {
      ...
      if (!email || !otp || !isOtpValid()) {
        console.log(
          "❌ [Password Screen] OTP missing or invalid, redirecting back...",
        );
      ...
      if (error) {
        ...
        if (
          ...
          toast.error("Invalid Code", {
            description:
              "Your verification code has expired or is invalid. Please request a new one.",
          });
            ...
            <View style={styles.inputContainer}>
              ...
              <View>
                <TextInput
                  ...
                  placeholder={
                    newPasswordFocused ? "" : "Enter your new password"
                  }
            ...
            <View style={styles.inputContainer}>
              ...
              <View>
                <TextInput
                  ...
                  placeholder={
                    confirmPasswordFocused ? "" : "Confirm your new password"
                  }
                  placeholderTextColor="#B0B8C1"
                  ...
                  returnKeyType="done"
                  onSubmitEditing={() =>
                    handleDebouncedPress(handleResetPassword)
                  }
